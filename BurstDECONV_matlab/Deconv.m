...
%%%%%%%%%%%%%%%% hardware parameters
nworkers = 16;  %%% max number of workers (less than the number of cores on your computer)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%


%%% all the generated mat files will be placed here
MatFilePath = 'output/matfiles/';
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
generations=200; %%%% number of generation in the GA step
...
name = strrep(fnameinput,'data_','');


fnameoutput = [MatFilePath,'result_',name];
