...
# -*- coding: utf-8 -*-
"""
Created on Mon Jun 19 21:13:35 2023
...
def fit3_commonPlot(dirwrite,name,dt,dtg,censored,censored_short,wt,wtc,lDEL,Total,Ninactive,visualize,time,sd):
    #print(sd)
    fsz=16 #figure size
    outliers_short = 1
    outliers_long = 1
