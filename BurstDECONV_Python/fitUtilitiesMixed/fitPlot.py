...
class fitPlot:
    def plotVals(path,parameter,combined,visualize,outputpath, fit3exp=True):
        ...
        csvfilename2states = DataFilePath0 + '/fit2_results.csv'
        ...
        xls_cont.to_csv(csvfilename2states, mode='a', index=False, header=True)
        
        #############################
        
        ### 3 states M1
        xlsfilename3statesM1 = DataFilePath0 + '/fit3M1_results.xlsx'
        csvfilename3statesM1 = DataFilePath0 + '/fit3M1_results.csv'
        ...
        xls_cont.to_csv(csvfilename3statesM1, mode='a', index=False, header=True)
        #########################
        
        ### 3 states M2
        xlsfilename3statesM2 = DataFilePath0 + '/fit3M2_results.xlsx'
        csvfilename3statesM2 = DataFilePath0 + '/fit3M2_results.csv' 
        ...
        xls_cont.to_csv(csvfilename3statesM2, mode='a', index=False, header=True)
        #########################
