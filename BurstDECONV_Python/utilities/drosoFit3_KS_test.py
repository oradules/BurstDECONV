    ...
    def __init__(self,path,parameterpath,combined,outputpath):
        ...
        for ifile in range(nfiles):
            ...
            if len(dt)!=0: 
                ...
                res= np.array([k1p,k1m,k2p,k2m,k3,p1,p2,p3,kk1p,kk1m,kk2p,kk2m,kk3,pp1,pp2,pp3,l1,l2,l3,A1,A2,A3,S1,objmin,aa,nn[1],nn[0]]) # optimum
                ...
                df2.to_excel(writer,sheet_name='Sheet1', startrow=4*(ifile+1)-3, startcol=0, header=False, index=False)
